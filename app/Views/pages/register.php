          ...
          <div class="col-lg-5">
            <div class="card bg-secondary shadow border-0">
              <div class="card-body px-lg-5 py-lg-5">
                ...
                <form role="form" method="post" action="<?= base_url(); ?>/User/daftar">
                <div class="form-group">
                    <div class="input-group input-group-alternative mb-3">
                      <div class="input-group-prepend">
                        <span class="input-group-text"><i class="ni ni-hat-3"></i></span>
                      </div>
                      <input class="form-control" placeholder="first_name" type="text" name="first_name" required autofocus>
                    </div>
                  </div>  
                  <div class="form-group">
                    <div class="input-group input-group-alternative mb-3">
                      ...
                      <input class="form-control" placeholder="last_name" type="text" name="last_name" required autofocus>
                    </div>
                  </div>
                <div class="form-group">
                    <div class="input-group input-group-alternative mb-3">
                    ...
                    <div class="input-group ">
                      ...
                      <select class="navbar-nav" name="role">
                          ...
                          <div class="dropdown-menu" aria-labelledby="nav-inner-primary_dropdown_1">
                            <option class="dropdown-item" name="role" value="author">Author</option>
                            <option class="dropdown-item" name="role" value="editor">Editor</option>
                            <option class="dropdown-item" name="role" value="reviewer">Reviewer</option>
                          </div>
                      </select>
                    </div>
                  </div>
