...
<head>
	<title>Editor/Author Correspondence</title>
	...
	<link rel="stylesheet" href="https://iptek.its.ac.id/styles/comments.css" type="text/css" />
...
<script type="text/javascript" src="https://iptek.its.ac.id/lib/pkp/js/lib/jquery/plugins/jquery.pkp.js"></script>	
			...
			<script language="javascript" type="text/javascript" src="https://iptek.its.ac.id/lib/pkp/lib/tinymce/jscripts/tiny_mce/tiny_mce_gzip.js"></script>
	...
	<script type="text/javascript" src="https://iptek.its.ac.id/lib/pkp/js/lib/jquery/plugins/jquery.pnotify.js"></script>
...
<?php if(isset($comment)) : ?>
    <div id="existingComments">
        <table class="data" width="100%">
            ...
            <tr valign="top">
                <td width="25%">
                    <div class="commentRole">Editor</div>
                    <div class="commentDate">2022-06-06 06:04 PM</div>
                </td>
                <td width="75%">
                                <div style="float: right"><a href="https://iptek.its.ac.id/index.php/itj/editor/deleteComment/12540/6091" onclick="return confirm('Are you sure you would like to delete this comment?')" class="action">Delete</a></div>
                            <div id="6091"></a>
                                <div class="commentTitle">Subject: a</div>
                            </div>
                    <div class="comments">test comment</div>
                </td>
            </tr>
            </div>
        </table>
...
<form method="post" action="/editor/postEditorDecisionComment">
    ...
    <input type="button" value="Close" class="button" onclick="window.close()" /></p>
