         ...
         <div class="container shape-container d-flex align-items-center py-lg">
            <div class="col px-0">
               <div class="row align-items-center d-flex justify-content-cente">
                  ...
                  <p><input type="submit" value="Save and continue" class="btn btn-primary btn-sm mr-3" onclick="window.location.href='<?= base_url('/author/submit/3/' . $article['article_id']); ?>'" />
                     <input type="button" value="Cancel" class="btn btn-primary btn-sm mr-3" onclick="if (confirm('You can complete this submission at a later date by selecting Active Submissions from the Author home.')) window.location.href='<?= base_url('/author'); ?>';" />
                  </p>
