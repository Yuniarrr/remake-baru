            ...
            <div class="col px-0">
               <div class="row align-items-center d-flex justify-content-cente">
                  ...
                  <form method="post" action="<?= base_url(); ?>/author/saveSubmit/5/<?= $article['article_id']; ?>">
                     ...
                     <p>
                        <input type="submit" value="Finish Submission" class="btn btn-primary btn-sm mr-3" />
                        <input type="button" value="Cancel" class="btn btn-primary btn-sm mr-3" onclick="confirmAction('<?= base_url(); ?>/author', 'You can complete this submission at a later date by selecting Active Submissions from the Author home.')" onclick="document.location.href='/author'" />
                     </p>
                  </form>
               </div>
            </div>
