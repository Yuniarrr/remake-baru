                  ...
                  <div id="authors">
                     ...
                     <table width="100%" class="data">
                        <tr valign="top">
                           ...
                           <td width="80%" class="value"><input type="text" class="textField" name="authors[0][firstName]" id="authors-0-firstName" value="<?php if(isset($author['first_name'])) echo $author['first_name']; else echo 'First Name'; ?>" size="20" maxlength="40" /></td>
                        </tr>
                        <tr valign="top">
                           <td width="20%" class="label">
                        ...
                        <tr valign="top">
                           ...
                           <td width="80%" class="value"><input type="text" class="textField" name="authors[0][lastName]" id="authors-0-lastName" value="<?php if(isset($author['author_id'])) echo $author['last_name']; else echo 'Last Name'; ?>" size="20" maxlength="90" /></td>
                        </tr>
                        <tr valign="top">
                           <td width="20%" class="label">
               ...
               <div id="indexing">
                  ...
                  <table width="100%" class="data">
                     ...
                     <tr valign="top">
                        ...
                        <td width="80%" class="value"><input type="text" class="textField" name="article[language]" id="language" value="<?php if(isset($article['article_id'])) echo $article['language']; else echo 'en'; ?>" size="5" maxlength="10" /></td>
                     </tr>
                     <tr valign="top">
