         ...
         <div class="col px-0">
            <div class="row align-items-center d-flex justify-content-cente">
               <form name="addArticle" method="post" action="<?= base_url(); ?>/author/saveSubmit/3/<?= $article['article_id']; ?>">
                  ...
                  <div id="authors">
                     ...
                     <?php if (isset($authors)) : ?>
                        <?php foreach ($authors as $author) : ?>
                           ...
                           <input type="hidden" name="authors[0][authorId]" value="<?php if (isset($author['author_id'])) echo $author['author_id']; ?>" />
                           ...
                           <table width="100%" class="data">
                              <tr valign="top">
                                 ...
                                 <td width="80%" class="value"><input type="text" class="textField" name="authors[0][firstName]" id="authors-0-firstName" value="<?php if (isset($author['first_name'])) echo $author['first_name'];
                              ...
                              <tr valign="top">
                                 ...
                                 <td width="80%" class="value"><input type="text" class="textField" name="authors[0][middleName]" id="authors-0-middleName" value="<?php if (isset($author['author_id'])) echo $author['middle_name'] ?>" size="20" maxlength="40" /></td>
                              </tr>
                              <tr valign="top">
                                 <td width="20%" class="label">
                                 ...
                                 <td width="80%" class="value"><input type="text" class="textField" name="authors[0][lastName]" id="authors-0-lastName" value="<?php if (isset($author['author_id'])) echo $author['last_name'];
                              ...
                              <tr valign="top">
                                 ...
                                 <td width="80%" class="value"><input type="text" class="textField" name="authors[0][email]" id="authors-0-email" value="<?php if (isset($author['author_id'])) echo $author['email']; ?>" size="30" maxlength="90" /></td>
                              </tr>
                              <tr valign="top">
                                 <td class="label">
                  ...
                  <p><input type="submit" name="submitArticle" value="Save and continue" class="btn btn-primary btn-sm mr-3" />
                     <input type="button" value="Cancel" class="btn btn-primary btn-sm mr-3" onclick="confirmAction('<?= base_url(); ?>/author', 'You can complete this submission at a later date by selecting Active Submissions from the Author home.')" />
                  </p>
